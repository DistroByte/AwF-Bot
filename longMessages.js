...
const factoriospcommands = {
  ...
  description:
    "These are all of the Factorio in-game console commands for singleplayer/client that can be used in +fcommand and +fcommandall. Some of them that can be used only on the Factorio client have a @ in front of the slash. Admin-only commands also have a # in front. Cheat commands have not been included",
  fields: [
    {
      name: "/alerts <enable/disable/mute/unmute> <alert>",
      value:
        "Enables, disables, mutes, or unmutes the given alert type. Available alerts: entity_destroyed, entity_under_attack, not_enough_construction_robots, no_material_for_construction, not_enough_repair packs, turret_fire, custom, no_storage, train_out_of_fuel, fluid_mixing",
    },
    {
      name: "/clear",
    ...
    },
    {
      name: "/version",
      value:
        "Prints the current game version - This is shown on Discord in channel description",
    },
  ],
};
const factoriompcommands = {
  ...
  description:
    "These are all of the Factorio in-game console commands for multiplayer/client that can be used in +fcommand and +fcommandall. Some of them that can be used only on the Factorio client have a @ in front of the slash. Admin-only commands also have a # in front. Cheat commands have not been included",
  fields: [
    {
      name: "#@/admin",
    ...
    },
    {
      ...
      value:
        "Adds or removes a player from the banlist. Same as /ban or /unban. /banlist get should show the people banned, not admin-only",
    },
    {
...
const ltn = {
  ...
  fields: [
    ...
    },
    {
      ...
      value:
        "The Logistic Train Stop allows the LTN mod to schedule trains to go from a Depot to a Provider station to a Requester station",
    },
    {
      name: "LTN Depot",
      value:
        "The LTN Depot is a Logistic Train Stop that is set for trains to be allowed to stop there when they are idling for a default period of 5s",
    },
    {
      name: "LTN Provider Station",
      value:
        "The LTN Provider station is a Logistic Train Stop that is set for trains to be allowed to pick items up, such as iron ore, steel, sulfuric acid etc to be then transported into LTN Requester Stations",
    },
    {
      name: "LTN Requester Station",
      value:
        "The LTN Requester Station is a Logistic Train Stop that is set for trains to deliver items to, such as red circuits require plastic (among others), so you would have one (or more) LTN Requester Stations wired up to request plastic",
    },
    {
      name: "\u200b", //blank/spacer field
      value: "\u200b",
    },
    {
      ...
      value:
        "If you would want to get the full description with everything, go [here](https://forums.factorio.com/viewtopic.php?f=214&t=51072) - the full fledged mod description by the creator, Optera",
    },
  ],
};
const servers = {
  ...
  description:
    "This is a short description of the servers All-Weekend-Factorio has to offer",
  fields: [
    {
      name: "Core",
      value:
        "Core is a sort of map that is reset once in a while when most users agree to, a pretty long period of time (between a few weeks to a few months). It has some QoL mods installed, but nothing too big. It is password protected.",
    },
    {
      name: "Corona Daycare",
      value:
        "Corona Daycare is the type of map that is reset once a week or every other week, with lots of new players, who sometimes join the AwF community. It is completely vanilla, no password",
    },
    {
      name: "Krastorio 2",
      value:
        "The Krastorio 2 map. This map includes some QoL mods and quite a bit of other, complex mods that go hand-in-hand with Krastorio 2. This map is complex, but not the most complex. It is much longer and complex than the default game",
    },
    {
      name: "seablock",
      value:
        "The seablock map is basically bobangels, but you make EVERYTHING from purely water (and the seabed). Therefore, everything is muuuuch more complex, runs last hundreds of hours",
    },
    {
      name: "bobs-angels",
      value:
        "A BobAngels playthrough. Includes mods from great authors, Bobingabout and Arch666Angel. They make the playthrough complex, but not as complex as seablock - here you have land, lots of it - but you also have biters",
    },
  ],
};
