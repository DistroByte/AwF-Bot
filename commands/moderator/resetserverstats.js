...
module.exports = {
  config: {
    ...
    category: "moderator",
    description:
      "Resets the deaths and other statistics of servers, not global statistics",
    ...
    if (
      ...
      if (!args[0])
        return message.channel.send(
          "Please give a Factorio Discord channel name"
        );
      let sentMsg = await message.channel.send(
        `Please confirm wiping of server ${args[0]}`
      );
      sentMsg.react("✅");
      sentMsg.react("❌");
