...
rometheus = require("prometheus/prometheus") --graftorio
require("utility") --graftorio
local translate = require("scripts/translation") --graftorio
local await_export = false --graftorio
...
-- This is graftorio magic from now on
function doExport()
